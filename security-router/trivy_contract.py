...
# Exact reviewed CyberCoach 4672975 source inventory and freshly observed IaC locations.
SOURCES = {'infra/aws/operator-foundations/access-logging.tf': 'c563039d82141b9fd97b83b9d6b901a7601f64dda6367865a61aa4ca75a0a3de', 'infra/aws/modules/audit-foundation/receivers.tf': '7bacfbc849b2e4b693a7b8cad9077560e07db492f2b3eb2d15fdffaf2c2a0c5f', 'infra/aws/modules/public-frontdoor/main.tf': '054cca79d41aa694c624104b81ff467c12647e4282042ca83df284557c01d1a6', 'infra/aws/modules/records/operator-tests/composed/main.tf': 'af35d548780a3dcd2ff99c47f18d8ae3d8c0035dffc91e6e28f66a02b250bd4e', 'infra/aws/public-frontdoor/main.tf': '1f5e66bcc52d7cd8ab6607323b938084634db7eda0a7bfd1b29941ca3b4dfc2b', 'infra/aws/modules/origin-authentication/main.tf': 'ea04621eeb448575338f4b68d8e8b89d0b6a865a52fef0259fa5289921328f15', 'infra/aws/origin-authentication/main.tf': 'e91d3579d779d12b1993471c2d5e0f8297ca3b7163032fd872ffb5b1efe6de2d', 'infra/aws/operator-database/stores.tf': '4245e0fb23bef76fb40afa3dab61c28f9adeba1183952316bdbc6849a65c11d4'}
...
EXPECTED = [{'rule': 'AWS-0089', 'severity': 'LOW', 'target': 'modules/audit-foundation/receivers.tf', 'provider': 'AWS', 'service': 's3', 'resource': 'module.audit', 'start_line': 64, 'end_line': 78, 'occurrences': [{'resource': 'module.audit', 'filename': 'modules/records/operator-tests/composed/main.tf', 'start_line': 11, 'end_line': 43}]}, {'rule': 'AWS-0132', 'severity': 'HIGH', 'target': 'modules/audit-foundation/receivers.tf', 'provider': 'AWS', 'service': 's3', 'resource': 'module.audit', 'start_line': 100, 'end_line': 107, 'occurrences': [{'resource': 'module.audit', 'filename': 'modules/records/operator-tests/composed/main.tf', 'start_line': 11, 'end_line': 43}]}, {'rule': 'AWS-0066', 'severity': 'LOW', 'target': 'modules/origin-authentication/main.tf', 'provider': 'AWS', 'service': 'lambda', 'resource': 'module.origin_authentication', 'start_line': 71, 'end_line': 91, 'occurrences': [{'resource': 'module.origin_authentication', 'filename': 'origin-authentication/main.tf', 'start_line': 37, 'end_line': 52}]}, {'rule': 'AWS-0010', 'severity': 'MEDIUM', 'target': 'modules/public-frontdoor/main.tf', 'provider': 'AWS', 'service': 'cloudfront', 'resource': 'module.public_frontdoor', 'start_line': 70, 'end_line': 132, 'occurrences': [{'resource': 'module.public_frontdoor', 'filename': 'public-frontdoor/main.tf', 'start_line': 107, 'end_line': 122}]}, {'rule': 'AWS-0014', 'severity': 'MEDIUM', 'target': 'operator-database/stores.tf', 'provider': 'AWS', 'service': 'cloudtrail', 'resource': 'aws_cloudtrail.database', 'start_line': 175, 'end_line': 175, 'occurrences': [{'resource': 'aws_cloudtrail.database', 'filename': 'operator-database/stores.tf', 'start_line': 169, 'end_line': 187}]}, {'rule': 'AWS-0089', 'severity': 'LOW', 'target': 'operator-foundations/access-logging.tf', 'provider': 'AWS', 'service': 's3', 'resource': 'aws_s3_bucket.access_logs', 'start_line': 40, 'end_line': 47, 'occurrences': []}, {'rule': 'AWS-0132', 'severity': 'HIGH', 'target': 'operator-foundations/access-logging.tf', 'provider': 'AWS', 'service': 's3', 'resource': 'aws_s3_bucket_server_side_encryption_configuration.access_logs', 'start_line': 69, 'end_line': 80, 'occurrences': []}]
